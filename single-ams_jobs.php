...
function ams_application_form () {
	...
	'.wp_nonce_field('ajax-recaptcha-nonce', 'security').'
	...
	<input class="ams-form-input" type="tel" name="phnumber" placeholder="123-45-678" "><br>
	...
	<input class="ams-form-input" type="file" id="myfile" name="resume" required><br>
	<div class="g-recaptcha" data-callback="onReturnCallback" data-sitekey="'.$site_key.'" ></div><p class="status"></p>
